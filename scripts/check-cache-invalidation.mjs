...
function checkB() {
  ...
  const violations = [...sitemapCacheViolations(repoRoot), ...directoryTextCacheViolations(repoRoot)];
  ...
  for (const rel of allowlist) {
    if ([...CDN_SITEMAP_ROUTES, ...CDN_DIRECTORY_TEXT_ROUTES].includes(rel)) continue;
