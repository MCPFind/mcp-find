...
For most developers, a GitHub MCP server is the highest-value first install. It lets Claude create issues, review pull requests, search code, and check CI status without leaving your editor. If you use Cursor or VS Code, see [how to use MCP with Cursor](/blog/how-to-use-mcp-with-cursor) for the exact config steps.
