...
The corresponding MCPFind directory entry is the [monday.com MCP server listing](/servers/com-monday-monday-com); review the [upstream repository](https://github.com/mondaycom/mcp) before installation.
