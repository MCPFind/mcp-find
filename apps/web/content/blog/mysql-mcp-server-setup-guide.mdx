...
For a concrete community option to assess against these criteria, see the [MySQL MCP server listing](/servers/io-github-neverinfamous-mysql-mcp) and its [upstream repository](https://github.com/neverinfamous/mysql-mcp).
