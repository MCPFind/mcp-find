...
export const CATEGORY_DESCRIPTIONS: Record<Category, string> = {
  ...
  ecommerce: 'Shopify, WooCommerce, Stripe, and similar e-commerce platform servers. Agents can manage products, read orders, handle inventory, process refunds, and pull sales data. Whether it\'s store management, customer service automation, or reporting — the commerce backend integrations live here.',
  ...
  productivity: 'The catch-all for tools that help people get work done: Notion, Airtable, Todoist, Google Workspace, Jira, and more. If you want an agent that can manage tasks, update project trackers, or coordinate information across your productivity stack, this is the place to look.',
...
export const CATEGORY_LLM_DESCRIPTIONS: Record<Exclude<Category, 'other'>, string> = {
  ...
  testing: 'Playwright, Cypress, Jest, Sentry, and testing framework/QA tool MCP integrations.',
  ...
  ecommerce: 'Shopify, WooCommerce, Stripe, and e-commerce platform MCP integrations for store and order management.',
